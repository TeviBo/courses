...
class ProfileFeedItem(models.Model):
    ...
    # El primer argumento es el nombre del modelo que sera el main para esta foreign key
    # El segundo argumento es on_delete,
    # lo que hace es decirle a Django que hacer si el modelo main se remueve
    # se remueva todo lo que este asociado a ese modelo
